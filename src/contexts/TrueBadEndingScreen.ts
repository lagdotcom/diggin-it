...
export default class TrueBadEndingScreen implements Context {
  stage: number;
    ...
    switch (this.stage) {
      ...
      case 5:
        ...
        chars.drawText(
          1,
          1,
          '"Begone from me, leave!" Jaques cries, falling to his knees."',
          38
        );
        break;
      ...
      case 9:
        ...
        chars.drawText(
         5,
         23,
          'Remembering nothing of this long voyage and sitting beside his wife and child in their ramshackle apartment, Jaques holds them close before departing on his first expedition.\n\n"I\'ll see you soon Lillica, Remi. I promise!"\n\n\nTO BE CONTINUED...',
          30
        );
        break; 
    }
