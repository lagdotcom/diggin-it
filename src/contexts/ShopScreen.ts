...
export default class ShopScreen implements Context {
  ...
  constructor(public g: Game) {
    ...
    this.useSection = new ShopSection(this, " USE", 10)
      .addByName("staple", 150)
      .addByName("ladder", 300)
      .addByName("rope", 300)
      .addByName("bomb", 400)
      .addByName("ropeBomb", 570)
      .addByName("cherryBomb", 620)
      .addByName("greenloaf", 260)
      .addByName("rations", 480)
      .addByName("medikit", 820)
      .addByName("breathTablet", 190)
      .addByName("airGum", 360)
      .addByName("airTank", 700)
      .addByName("serum", 480)
      .addByName("adrenaline", 480)
      .addByName("suture", 480)
      .addByName("rock", 100)
      .addByName("arrow", 200)
      .addByName("blowdart", 200)
      .addByName("mambele", 360)
      .addByName("bolas", 700);

    this.equipSection = new ShopSection(this, "EQUIP", 18)
      .addByName("pocketknife", 900)
      .addByName("shovel", 1200)
      .addByName("pickaxe", 1800)
      .addByName("hammer", 2650)
      .addByName("axe", 3100)
      .addByName("claws", 3600)
      .addByName("machete", 4200)
      .addByName("slingshot", 600)
      .addByName("blowgun", 2800)
      .addByName("bow", 4000)
      .addByName("clothes", 800)
      .addByName("reinforced", 1200)
      .addByName("spelunkersKit", 1800)
      .addByName("militaryMail", 2300)
      .addByName("squadLeaderGear", 2800)
      .addByName("busterArmour", 3200)
      .addByName("wingArmour", 3500);
