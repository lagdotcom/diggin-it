...
export default class ShopScreen implements Context {
  ...
  constructor(public g: Game) {
    ...
    this.useSection = new ShopSection(this, " USE", 10)
      .addByName("bomb", 300)
      .addByName("ladder", 250)
      .addByName("rations", 400)
      .addByName("airTank", 600)
      .addByName("rope", 250)
      .addByName("bolas", 600)
      .addByName("rock", 30)
      .addByName("staple", 100)
      .addByName("mambele", 300)
      .addByName("arrow", 150)
      .addByName("medikit", 700)
      .addByName("ropeBomb", 500)
      .addByName("cherryBomb", 600)
      .addByName("greenloaf", 200)
      .addByName("serum", 400)
      .addByName("adrenaline", 400)
      .addByName("suture", 400)
      .addByName("breathTablet", 150)
      .addByName("airGum", 300)
      .addByName("blowdart", 150);

    this.equipSection = new ShopSection(this, "EQUIP", 18)
      .addByName("pickaxe", 1500)
      .addByName("pocketknife", 750)
      .addByName("slingshot", 500)
      .addByName("shovel", 1000)
      .addByName("hammer", 2200)
      .addByName("machete", 3500)
      .addByName("claws", 3000)
      .addByName("clothes", 300)
      .addByName("reinforced", 500)
      .addByName("spelunkersKit", 650)
      .addByName("militaryMail", 850);
