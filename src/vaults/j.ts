...
const leak = new Vault("gas leak", 1, [
  "]]      ]]",
  "]]]|]]|]]]",
  "]|%|%]|%%]",
  "]|#####%^]",
...
const cool = new Vault("Cool Drink", 1, [
  "##~~~##",
  "#~~~~~#",
  "#~~~~~#",
  "#~~9~~#",
...
const cooler = new Vault("Cooler Drink", 2, [
  "###~~~###",
  "]~~~~~~~]",
  "]]]]]]]~]",
  "]~~~~~~~]",
...
const gas = new Vault("Have A Gas", 1, ["]]#]", "]G%%", "]]#]"]);

const blast = new Vault("Have A Blast", 1, ["###", " B ", "###"]);

const bridge = new Vault("Bridge", 1, [
  "]]]]]]]]]",
  "]OOOOOOO]",
  ":::::::::",
  "c       c",
...
// TODO: won't work rn
// const secret = new Vault("Beelzebub's Secret", 3, [
//   "::::]]]]]]]",
//   ":%%%%%%%%%]",
//   "]]]]]]]]]%]",
//   "]%%%%%%%]%]",
...
const eye = new Vault("Swimmer's Eye", 1, [
  "   ]###]    ",
  "  ]    ]##  ",
  " ]    ]   # ",
  "]~~~~#  A  #",
...
const drowning = new Vault("Gray Days Drowning", 1, [
  "]]~~~~~~~~~~]]",
  "#~~~]]]]~~~~~#",
  "]~~~~~~~~~~~~]",
  "]~~]]~~~]]~~~]",
...
const well = new Vault("the well", 1, [
  "]~~~~~]",
  "]~~~~~]",
  "]~~~~~]",
  "]~~~~~]",
